...
class ServiceCallbacks(Service):
    ...
    def cb_create(self, tctx, root, service, proplist):
        ...
        try:
            ...
            # PREPARE A-SIDE
            vars.add('DEVICE',        root.lsa_evpn__evpn.sites.site[service.a].device)
            vars.add('CE_INTERFACE',  root.lsa_evpn__evpn.sites.site[service.a].interface)
            vars.add('RD_IPV4',       root.lsa_evpn__evpn.sites.site[service.a].ipv4_address)
            ...
            # PREPARE Z-SIDE
            vars.add('DEVICE',        root.lsa_evpn__evpn.sites.site[service.z].device)
            vars.add('CE_INTERFACE',  root.lsa_evpn__evpn.sites.site[service.z].interface)
            vars.add('RD_IPV4',       root.lsa_evpn__evpn.sites.site[service.z].ipv4_address)
